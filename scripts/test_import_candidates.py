...
# hangar-panel-action não tem extensão .py: spec_from_file_location não acha loader por sufixo e
...
def test_scan_roots_executa():
    # _scan_roots usa env() de hangar_panel_common — se o import faltar, dá NameError. Este teste
