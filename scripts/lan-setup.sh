...
#
# One-time setup — firewall rules persist across reboots; you do NOT need to run this
# every time you start the app. Detects ufw / firewalld / nftables. Idempotent.
#
# Usage:
