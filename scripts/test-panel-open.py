...
JANELAS_KITTY1 = [
    ...
    {"pid": 63482, "class": "kitty", "title": "my-web-app", "address": "0xBBB"},
...
CLIENTES = {"claude-cockpit-2": [2324949], "jefferson": [615602],
            "my-web-app": [2562331], "my-service": [2606971]}

TITULOS = {"claude-cockpit-2": "claude-cockpit", "jefferson": "jefferson",
           "my-web-app": "my-web-app", "my-service": "my-service"}
...
def main() -> int:
    ...
    esperado = {"my-service": "0xAAA", "my-web-app": "0xBBB",
