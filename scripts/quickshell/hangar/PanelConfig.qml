...
// Config do painel em ~/.config/hangar-panel.json (FileView + JsonAdapter, mesmo padrão
...
Singleton {
    ...
    readonly property string filePath: Quickshell.env("HOME") + "/.config/hangar-panel.json"
