// Modified for gpui-pre (snapshot of zed@bcf6582): the gpui sources it reads are vendored under `vendor/gpui`.
// Modificado pelo Hangar: bindings de desfoque portados de zeronsh/zui 18a89af.
