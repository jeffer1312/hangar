...
impl Window {
    ...
    /// Request a blur of already-painted content inside a rounded region.
    /// Draw a translucent fill afterwards for renderers without blur support.
    pub fn paint_backdrop_blur(
        ...
        // A transparent shadow splits batches at the blur's draw order.
