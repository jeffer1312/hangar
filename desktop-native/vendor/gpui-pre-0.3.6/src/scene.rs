...
impl Scene {
    ...
    pub fn insert_backdrop_blur(&mut self, mut blur: BackdropBlur) {
        ...
        self.paint_operations.push(PaintOperation::BackdropBlur(blur));
    }
...
impl<'a> Iterator for BatchIterator<'a> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        // The invisible shadow at each blur keeps the preceding batch separate.
        while self
            .backdrop_blurs_iter
...
impl PrimitiveBatch {
    /// First scene order in this batch; earlier backdrop blurs precede it.
