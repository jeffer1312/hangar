...
def _norm(s: str) -> str:
    ...
    # Marcador de lista entra na mesma regra: a TUI pinta `- item` como `• item`, e sem tirar os
    # dois o último bloco commitado voltava como bolha fantasma toda vez que o app abria a sessão.
