...
export type TelaConfig = 'root' | 'aparencia' | 'ditado' | 'notificacoes' | 'anexos' | 'avancado' | 'motores' | 'sobre';

const TELAS: readonly TelaConfig[] = ['root', 'aparencia', 'ditado', 'notificacoes', 'anexos', 'avancado', 'motores', 'sobre'];
