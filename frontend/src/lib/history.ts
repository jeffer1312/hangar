 ...
 *  fica intacto. Sem NENHUMA sobreposicao (ficou tempo demais fora e a cauda pulou o que tinhamos,
 *  ou o transcript trocou) a cauda passa a ser a verdade: melhor uma lista curta e continua do que
 *  duas metades sem o meio — o historico antigo volta logo depois pela carga de fundo. O chamador
 *  detecta esse caso comparando o primeiro id antes/depois. */
