<script lang="ts">
  ...
  const CAMPOS: Campo[] = [
    ...
    { chave: 'ditado_vocabulario', rotulo: 'Palavras do seu ditado', tipo: 'texto', secao: 'anexos',
      ajuda: 'Separadas por vírgula. Nomes que a transcrição erra por não serem português: projeto, sessão, cliente, jargão. Os termos do próprio app já entram sozinhos.' },
    ...
    { chave: 'llm_model', rotulo: 'Modelo do LLM', tipo: 'texto', secao: 'avancado',
      ajuda: 'Nome do modelo no serviço escolhido. Vazio = openai/gpt-oss-120b.' },
    { chave: 'llm_reasoning_effort', rotulo: 'Raciocínio do LLM', tipo: 'texto', secao: 'avancado',
      ajuda: 'Só para modelo que raciocina: "none" desliga. Pensar demora, e a limpeza do ditado desiste em 8 segundos. Vazio = não manda nada, que é o certo pra quase todo modelo.' },
