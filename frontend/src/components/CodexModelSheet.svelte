<script lang="ts">
  ...
  // ClaudeEffortPopover). Esta e a unica das tres pills que ainda abre FOLHA, nao popover.
  // Auto-contido igual ao CodexLimitsSheet (Task B): busca a lista + escolha atual ao
