<script lang="ts">
  ...
  import type { AskQuestionPayload, AskQuestionItem, AnswerItem } from '../lib/types';
  ...
  interface Props {
    ...
    onClose: () => void;
    onFallback: () => void; // abre o espelho TUI se algo falhar
  }
  let { open, payload, onSubmit, onClose, onFallback }: Props = $props();
